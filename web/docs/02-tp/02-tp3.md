...
- L'utilisation de l'IAG pour créer partiellement ou totalement des éléments du travail entrainera automatiquement un zéro et un plagiat
...
## Modifiez la vue **Index** du controleur **Records** 
1. Ajoutez le code nécessaire afin d'intégrer une librairie js proposant un DataTable (tel que datatables.net), vous pouvez choisir une autre librairie
