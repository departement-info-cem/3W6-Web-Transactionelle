...
- Il faut télécharger ce [fichier zip](../../static/tps/tp3/TP3_JuliePro_DepartE26.zip) 
...
2. Remplacez la pagination par du **scrolling vertical**, allez voir la [documentation](https://datatables.net/examples/index) pour trouver le bon type de scrolling. Mettez la valeur du paramètre **scrollY** à **400px** pour voir d'avantage de lignes.

|![Image Reference](/tps/tp3/DataTableTrieeForage2.png)|
|-|

3. Dans votre code HTML, ajoutez un **footer** (`<tfoot></tfoot>`) à la table avec **une rangée** et le bon **nombre de colonnes**, mais **sans contenu textuel**. 

4. À l'aide des fonctionnalités offertes par DataTables, ajoutez une **recherche par sélection** pour les colonnes **Discipline** et **Trainer**, allez voir la [documentation](https://datatables.net/examples/api/) pour vous aider. 
:::info
