...
2. Si ce n'est pas déjà fait, il faut ajouter une nouvelle option qui doit se nommer **Stats** sous **Admin**, dans le menu de navigation pour pouvoir accéder à la page de statistiques.
...
2. Finalement, il faut ajouter une nouvelle option qui doit se nommer **Objectives** sous **Admin**, dans le menu de navigation pour pouvoir accéder à la page d'objectifs.
3. Voici ce que l'on doit voir dans ce menu:
...
| Affichage de statisques avec requêtes Linq      |     2     |
