...
- Il faut télécharger ce [fichier zip](/tps/tp2/TP2_JuliePro_JS_ViewModelService_DepartA25.zip) qui contient les images utilisées dans le projet et extraire son contenu dans le répertoire **/wwwroot/** de votre projet
