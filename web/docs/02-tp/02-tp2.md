...
Si vous avez une erreur, assurez-vous d'utiliser la dernière version des librarires dans votre projet 6.0.X (Présentement 6.0.24, sauf pour la librairie Microsoft.VisualStudio.Web.CodeGeneration.Design qui utilise 6.0.16)
